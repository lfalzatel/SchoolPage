...
/**
 * Convierte un Blob/File a String Base64 Data URL (Fallback ultraligero)
 */
 ...
 * @param {string} pathRuta Ruta en Storage (ej. 'huerta/cultivo_123')
...
export async function uploadOrCompressPhoto(file, pathRuta = "huerta/general") {
  ...
  try {
    ...
    console.warn("Firebase Storage no disponible o rechazado. Aplicando Fallback a Base64 optimizado en Firestore...", err);
    // 3. Fallback transparente a Base64 (~40KB cabe sin problemas en Firestore)
